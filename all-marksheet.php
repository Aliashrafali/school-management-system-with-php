            ...
            <div class="row">
                <div class="col-5">
                    <div class="home-title">
                        ...
                        <span style="margin-left: 7px; margin-right: 7px; font-weight: 200; font-family: 'Exo 2';"><i class="fas fa-angle-right"></i><i class="fas fa-angle-right"></i></span><span> All Marksheet</span>
                    </div>
                </div> 
            </div>
        </div>
