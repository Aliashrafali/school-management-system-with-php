            ...
            <div class="row" style="border-bottom: 0.1px solid #EEE;">
                <div class="col-12 col-md-4 p-0 m-0">
                    <div class="top-header-left">
                        <a href="">Mob. & Whatsapp : 9006861511, 6201675471,</a><br>
                ...
                <div class="col-12 col-md-4 p-0 m-0">
                    <div class="top-header-right" style="padding-right: 20px!important;">
                        ...
                        <div id="profile">
                            <div class="logout">
                                <a href="#" class="admin-active"><i class="far fa-user"></i> Hello, Ashraf</a>
                                <a href="#" style="color: red; font-weight: 600;"><i class="fas fa-sign-out-alt"></i> Logout</a>
                            </div>
                        </div>
                    </div>
                </div>
